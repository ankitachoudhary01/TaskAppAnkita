package com.example.taskappankita.ViewModel
...
class photosViewModel constructor(private val repository: photosRepository)  : ViewModel() {

    val photoList = MutableLiveData<List<photosModel>>()
